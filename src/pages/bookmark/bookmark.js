...
var BookmarkPage = /** @class */ (function () {
    function BookmarkPage(navCtrl, alertCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.alertCtrl = alertCtrl;
        this.navParams = navParams;
        this.posts = [];
        // this.names = ['Ram','Syam'];
        //              this.posts = ['post 1','post 2'];
        this.posts = [
            {
                "Photo": "",
                "Description": "abcd"
    ...
    BookmarkPage.prototype.addEvent = function () {
        var _this = this;
    ...
    BookmarkPage.prototype.addEvents = function () {
        var _this = this;
    ...
    BookmarkPage.prototype.GoToDetails = function () {
